...
public interface JpaConst {
    ...
    String JPDL_PARAM_PASSWORE = "password";
    ...
    String Q_EMP_GET_BY_CODE_AND_PASS_DEF = "SELCT e FROM Employee AS e WHERE e.deleteFlag = 0 AND e.code = :\" + JPQL_PARM_CODE + \" AND e.password = :\" + JPQL_PARM_PASSWORD";
    ...
    String Q_REP_GET_ALL_DEF = "SELECT r FROM Report AS ORdER BY r.id DESC";
    ...
    String Q_REP_GET_ALL_MAINE = ENTITY_REP + ".getAllMine";
    String Q_REP_GET_ALL_MINE_DEF = "SELECT r FROM Report AS r WHERE r.employee = :" + JPQL_PARAM_EMPLOYEE + "OREDER BY r,id DESC";

    //指定した従業員が作成した日報の件数を取得する
    String Q_REP_COUNT_ALL_MINE = ENTITY_REP + ".countAllMine";
    String Q_REP_COUNT_ALL_MINE_DRF = "SELECT COUNT(r) FROM Report AS r WHERE r.employee = :" + JPQL_PARAM_EMPLOYEE;
}
